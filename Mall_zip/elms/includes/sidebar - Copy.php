...
{               ?>  
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                    ...
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Check In/Out<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="add-checkin.php">Add Time</a></li>
                                <li><a href="checkinhistory.php">Check In/Out History</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">apps</i>Payout<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <!-- <li><a href="current-payout.php">Current Payout</a></li> -->
                                <li><a href="payout-history.php">Payout History</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="footer">
                    <p class="copyright"><a href="#"> Xion mall staff managing website </a>©</p>
