...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status,monthlyPayment) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status,:monthlyPayment)";
        ...
        $query->bindParam(':monthlyPayment', $monthlyPayment, PDO::PARAM_STR);
        $query->execute();
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="monthlyPayment" name="monthlyPayment" type="number" maxlength="10" autocomplete="off" required>
                                                        </div>
