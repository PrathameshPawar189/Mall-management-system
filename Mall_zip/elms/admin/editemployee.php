...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno,monthlyPayment=:monthlyPayment where id=:eid";
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col s12">
                                                            ...
                                                            <input id="monthlyPayment" name="monthlyPayment" type="number" value="<?php echo htmlentities($result->monthlyPayment); ?>" maxlength="10" autocomplete="off" required>
                                                        </div>
