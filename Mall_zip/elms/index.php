...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Xion mall staff managing website | Home Page</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">Xion mall staff managing website</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright"><a href="https://litdeveloper.in/">ELMS </a>©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Xion mall staff managing website</h4></div>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               <div class="input-field col s12">
                                                   <input id="username" type="text" name="username" value="" class="validate" autocomplete="off" required >
                                                   <label for="email">Email Id</label>
                                               </div>
                                               <div class="input-field col s12">
                                                   <input id="password" type="password" class="validate" value="" name="password" autocomplete="off" required>
